...
$smallinvoice = new Smallinvoice('mytoken');
...
try {
    ...
    $objClientResponse = $smallinvoice->client_add($objClient);
    $objClientResponse = $smallinvoice->client_get($objClientResponse->id);
    ...
    $objInvoiceResponse = $smallinvoice->invoice_add($objInvoice);
